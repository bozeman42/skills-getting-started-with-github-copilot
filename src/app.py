...
activities = {
    ...
    "Drama Club": {
        "description": "Rehearse scenes, study acting, and put on school performances",
        "schedule": "Mondays, 5:00 PM - 6:30 PM",
        "max_participants": 20,
        "participants": ["sarah@mergington.edu", "linda@mergington.edu"]
    },
    "Art Workshop": {
    ...
    "Science Olympiad": {
        "description": "Prepare for STEM competitions and build science project skills",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["alexis@mergington.edu", "michael@mergington.edu"]
    },
    "Debate Team": {
